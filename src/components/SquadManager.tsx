    ...
    <>
      ...
      <div className="w-full flex justify-center items-center">
        <a
          ...
          className={`text-start ${team.mainColor === "#ffffff" ? "border border-mainblack" : ""} mt-4 w-75 flex flex-col gap-4 relative text-sm md:text-md xl:text-[16px] hover:opacity-80 hover:scale-[0.98] transition`}
        >
          <div
