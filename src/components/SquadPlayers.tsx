...
const SquadPlayers = ({ players, team }: { players: Player[]; team: Team }) => {
    ...
    const getPositionKey = (position: string): "goalkeepers" | "defenders" | "midfielders" | "forwards" => {
                ...
                player.position === player.position ? (
                  ...
                  >
                    ...
                    <div
                        ...
                        style={{ backgroundImage: `url('/src/images/background-teams-grid.webp')`}}
                    />
                    ...
                    <div className="flex flex-col justify-center relative gap-4 z-10">
                      <div className="self-center flex flex-row gap-2">
                        <p className="text-bold text-lg sm:text-2xl font-laliga self-end" style={{ color: textColorByTeam(team.id) }}>
                          {player.knownAs !== null
                            ? player.knownAs
                            : player.lastName}
                        </p>
                      ...
                      <div className="flex flex-row justify-center items-center gap-1">
                        ...
                        <p className="uppercase font-bold text-[10px] sm:text-sm" style={{ color: textColorByTeam(team.id) }}>
                          {translator(currentLang, "defender")}
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 col-span-2 border-t pt-2 gap-4 relative z-10 place-self-center" style={{ color: textColorByTeam(team.id) }}>
                      <div>
